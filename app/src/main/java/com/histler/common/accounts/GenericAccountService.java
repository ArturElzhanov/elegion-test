...
package com.histler.common.accounts;
...
public class GenericAccountService extends Service {
     ...
     * res/xml/weather_sync_adapter.xml). If this is not set correctly, you'll receive an error indicating
     ...
     *                    android.accounts.AccountAuthenticator (e.g. res/xml/weather_sync_adapter.xml).
